...
<<<<<<< HEAD
    ...
    def load_param(self):
        self.Init_Pos_AA         = copy.deepcopy(config['Init_Pos_AA'])
        self.Init_Pos_FE         = copy.deepcopy(config['Init_Pos_FE'])
        self.Init_Cur_FE         = copy.deepcopy(config['Init_Cur_FE'])
        self.PositionLimit_FE    = copy.deepcopy(config['PositionLimit_FE'])
        self.PositionMinLimit_FE = copy.deepcopy(config['PositionMinLimit_FE'])
        self.PositionLimit_AA    = copy.deepcopy(config['PositionLimit_AA'])
        self.PositionMinLimit_AA = copy.deepcopy(config['PositionMinLimit_AA'])
        self.CurrentLimit_FE     = copy.deepcopy(config['CurrentLimit_FE'])
        self.CurrentLimit_AA     = copy.deepcopy(config['CurrentLimit_AA'])
        self.Gain_position_FE    = copy.deepcopy(config['Gain_position_FE'])
        self.Gain_position_AA    = copy.deepcopy(config['Gain_position_AA'])
        self.Grasp_Target_Cur_AA = copy.deepcopy(config['Grasp_Target_Cur_AA'])
